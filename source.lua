...
function DevicesVM:Init()
    ...
    local Functions = loadstring(game:HttpGet("https://github.com/untitleddev11/Devices-VM-main/blob/main/dependencies/functions.lua"))()
    local Games = game:HttpGet("https://github.com/untitleddev11/Devices-VM-main/blob/main/dependencies/games.json")
    ...
    if PlaceId == nil then
        setclipboard("https://github.com/untitleddev11/Devices-VM-main/blob/main/dependencies/games.json")
